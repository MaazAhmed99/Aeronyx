    ...
    <div ref={containerRef} className="bg-slate-50 text-slate-900 overflow-x-hidden" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", minHeight: '100vh' }}>
      ...
      <section className="gallery-section py-24 bg-white/50">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { front: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&auto=format&fit=crop&q=80", title: "Hybrid Systems", sub: "Combining grid and wind for maximum efficiency", backTitle: "Hybrid Integration", backDesc: "Our hybrid systems combine wind and grid power with intelligent load balancing, providing 24/7 renewable energy with 99.5% reliability.", tags: ["Grid + Wind", "AI Control"] },
