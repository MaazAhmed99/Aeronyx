...
import { Wind, Wrench, Zap, HardHat, Cpu, ArrowRight } from "lucide-react";
...
const PARTNER_TYPES = [
  {
    icon: Wind,
    title: "Turbine Suppliers",
    desc: "We source high-performance turbines from trusted manufacturers to ensure reliability and efficiency across every installation.",
    color: "text-sky-500",
    bg: "bg-sky-50",
  ...
  },
  {
    ...
    desc: "Licensed electrical partners handle grid connections, compliance testing, and certified G98/G99 installations.",
  ...
  },
  {
    ...
    desc: "Civil and structural partners manage foundations, site prep, and tower erection to the highest safety standards.",
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(".section-heading", {
        scrollTrigger: { trigger: ".partners-grid", start: "top 90%", toggleActions: "play none none none" },
        opacity: 0, y: 40, duration: 0.9, ease: "power2.out", immediateRender: false,
      });

      gsap.from(".partner-card", {
        scrollTrigger: { trigger: ".partners-grid", start: "top 80%", toggleActions: "play none none none" },
    ...
    <div ref={containerRef} className="bg-slate-50 text-slate-900 overflow-x-hidden" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", minHeight: "100vh" }}>
      ...
      <style>{`
        ...
        *{font-family:'Plus Jakarta Sans',sans-serif;box-sizing:border-box}
        ...
        .partner-card{transition:transform .45s cubic-bezier(.22,1,.36,1),box-shadow .45s}
        .partner-card:hover{transform:translateY(-8px) scale(1.02);box-shadow:0 20px 40px rgba(2,6,23,0.12)}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="hero-heading">
                <span className="inline-block bg-indigo-100 text-indigo-700 text-xs font-bold px-3 py-1 rounded-full mb-5 tracking-wide uppercase">Partners</span>
                <h1 className="text-5xl lg:text-7xl font-black leading-[1.08] mb-6">
                  Partner With <span className="gradient-text">Aeronyx</span>
                </h1>
              </div>
              <div className="hero-sub">
                <p className="text-xl text-slate-600 leading-relaxed mb-8">
                  We collaborate with suppliers, engineering firms, and infrastructure partners to deliver high-performance energy solutions.
                </p>
            ...
            <div className="hero-image relative">
              ...
              <div className="hero-badge absolute -bottom-4 -left-4 md:-left-8 glass-card rounded-2xl px-5 py-3 shadow-lg flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-black">4 Partner Types</div>
                  <div className="text-xs text-slate-500">Trusted Network</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <div className="section-heading text-center mb-16">
            <h2 className="text-4xl font-black mb-4">Our Partner Network</h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">A trusted ecosystem of specialists delivering excellence at every stage.</p>
          </div>
          <div className="partners-grid grid md:grid-cols-2 gap-8">
            {PARTNER_TYPES.map((p) => (
              <div key={p.title} className={`partner-card glass-card rounded-3xl p-8 border ${p.border} relative overflow-hidden`}>
                <div className="absolute -top-16 -right-16 w-40 h-40 rounded-full opacity-20 pointer-events-none" style={{ background: `radial-gradient(circle,${p.accent},transparent 70%)` }} />
      ...
      <section className="cta-section py-24">
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          <div className="glass-card rounded-3xl p-12 shadow-xl relative overflow-hidden">
            ...
            <h2 className="text-3xl lg:text-4xl font-black mb-4 relative z-10">Become a Partner</h2>
            <p className="text-lg text-slate-600 mb-8 max-w-xl mx-auto relative z-10">
              Join our growing network of industry leaders shaping the future of renewable energy in the UK.
            </p>
